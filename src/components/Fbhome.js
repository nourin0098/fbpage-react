...
function Fbhome() {
  return (
    ...
    <div className='p-5'>
      <h1 className='text-3xl text-center text-blue-600 font-bold mb-3 m-3'>Welcome To Facebook</h1>
      <h2 className="block text-center text-black mt-4">The world biggest social network</h2>
    </div>
        </div>
        </div>
        </div>
